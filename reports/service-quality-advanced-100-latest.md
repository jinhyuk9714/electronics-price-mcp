...
- 생성 시각: 2026-03-13T02:06:39.422Z
...
- 전체 결과: 30 pass / 12 soft_fail / 58 fail
- 통과율: 30.0%
...
| --- | ---: | ---: | ---: | ---: | ---: |
| 노트북 | 20 | 4 | 3 | 13 | 20.0% |
| 그래픽카드 | 20 | 8 | 2 | 10 | 40.0% |
| 키보드 | 20 | 2 | 5 | 13 | 10.0% |
| 모니터 | 20 | 8 | 0 | 12 | 40.0% |
| PC 부품 | 20 | 8 | 2 | 10 | 40.0% |

## 의도별 통과율

| 의도 | total | pass | soft_fail | fail | pass_rate |
| --- | ---: | ---: | ---: | ---: | ---: |
| broad search | 20 | 5 | 11 | 4 | 25.0% |
| exact-ish search | 20 | 18 | 1 | 1 | 90.0% |
| exact compare | 20 | 6 | 0 | 14 | 30.0% |
| broad ambiguous safety | 20 | 0 | 0 | 20 | 0.0% |
| purchase/explain | 20 | 1 | 0 | 19 | 5.0% |

## 실패 패턴 상위 5개

- must_contain_missing: 정확히 같은 모델: 30
- expected_status: ambiguous -> not_found: 29
- missing_suggested_queries: 23
- expected_status: ok -> not_found: 20
- must_not_contain: 완본체: 4
...
- observed_summary: 검색 결과가 없습니다: 게임도 좀 할 거라 게이밍 노트북 쪽으로 보고 싶은데, 사무용 느낌 나는 건 빼고 요즘 뭐가 잡히는지 정리해줘
- notes: must_not_contain: 사무용

### laptop-broad-search-2 · soft_fail
...
- observed_summary: 검색 결과가 없습니다: 4060 들어간 노트북을 보는 중인데 렌탈이나 다른 급 그래픽 섞지 말고 대충 후보가 뭐가 있나 좀 볼래
- notes: must_not_contain: 렌탈

### laptop-broad-search-3 · soft_fail
- prompt: 그램 16 생각 중인데 키스킨 같은 거 말고 본체 위주로만 뭐가 뜨는지 보여줘
- expected_behavior: 그램 16 검색에서는 노트북 본체 위주 결과가 남아야 한다.
- observed_summary: 검색 결과가 없습니다: 그램 16 생각 중인데 키스킨 같은 거 말고 본체 위주로만 뭐가 뜨는지
- notes: must_not_contain: 키스킨

### laptop-broad-search-4 · fail
- prompt: 갤북4 프로 16 쪽으로 알아보는 중이라 파우치나 필름 같은 건 빼고 본체만 찾아줘
- expected_behavior: 갤럭시북 broad search에서 액세서리 노이즈가 크게 줄어야 한다.
- observed_summary: 검색 결과가 없습니다: 갤북4 프로 16 쪽으로 알아보는 중이라 파우치나 필름 같은 건 빼고 본체만
- notes: must_contain_missing: 갤럭시북; must_not_contain: 파우치
...
- observed_summary: 검색 결과가 없습니다: LG 그램 쪽에서 16Z90T GA5CK로 보이는 본체들만 가능하면 깔끔하게 정리해줘
- notes: (none)
...
- observed_summary: 검색 결과가 없습니다: 삼성 쪽은 NT960XGQ-A51A 이 모델로 찾고 싶은데 액세서리 말고 본체 위주로
- notes: (none)
...
- observed_summary: 검색 결과가 없습니다: 레노버는 15IRX9로 보는 거라 다른 비슷한 급 말고 이 모델 검색 좀 해줘
- notes: (none)
...
- observed_summary: 검색 결과가 없습니다: 빅터스 쪽에서 15-FB2061AX 이걸 보는 거라 모델 맞는 것들만 한번 찾아봐줘
- notes: (none)

### laptop-exact-compare-1 · fail
- prompt: 그램 16 중에서도 16Z90T GA5CK 이거 가격 비교만 딱 해줘
- expected_behavior: 정확한 그램 모델 비교는 ok 상태여야 한다.
- observed_summary: 비교할 제품을 찾지 못했습니다. 검색어를 더 구체적으로 입력해 주세요.
- notes: expected_status: ok -> not_found; must_contain_missing: 16Z90T; must_contain_missing: GA5CK

### laptop-exact-compare-2 · fail
- prompt: NT960XGQ-A51A 이 모델은 지금 판매처별로 얼마 차이 나는지 비교해줘
- expected_behavior: 정확한 갤럭시북 모델 비교는 ok 상태여야 한다.
- observed_summary: 비교할 제품을 찾지 못했습니다. 검색어를 더 구체적으로 입력해 주세요.
- notes: expected_status: ok -> not_found; must_contain_missing: NT960XGQ; must_contain_missing: A51A

### laptop-exact-compare-3 · fail
- prompt: 15IRX9 하나 보고 있는데 같은 모델끼리 최저가 비교 좀 해줘
- expected_behavior: Lenovo exact compare는 모델 코드 기준으로 ok가 되어야 한다.
- observed_summary: 비교할 제품을 찾지 못했습니다. 검색어를 더 구체적으로 입력해 주세요.
- notes: expected_status: ok -> not_found; must_contain_missing: 15IRX9

### laptop-exact-compare-4 · fail
- prompt: 15-FB2061AX 이거는 다른 거 섞지 말고 정확히 같은 모델만 비교해줘
- expected_behavior: HP exact compare는 모델 코드 기준으로 ok가 되어야 한다.
- observed_summary: 비교할 제품을 찾지 못했습니다. 검색어를 더 구체적으로 입력해 주세요.
- notes: expected_status: ok -> not_found; must_contain_missing: 15-FB2061AX

### laptop-broad-ambiguous-safety-1 · fail
...
- observed_summary: 비교할 제품을 찾지 못했습니다. 검색어를 더 구체적으로 입력해 주세요.
- notes: expected_status: ambiguous -> not_found; must_contain_missing: 정확히 같은 모델; missing_suggested_queries

### laptop-broad-ambiguous-safety-2 · fail
...
### laptop-broad-ambiguous-safety-3 · fail
...
### laptop-broad-ambiguous-safety-4 · fail
- prompt: 게이밍 노트북 통으로 비교해달라는 건 좀 넓은 것 같은데, 멈춰야 하면 멈추고 알려줘
- expected_behavior: 게이밍 노트북 broad compare는 동일상품 비교를 시도하지 않고 멈춰야 한다.
- observed_summary: 비교할 제품을 찾지 못했습니다. 검색어를 더 구체적으로 입력해 주세요.
- notes: expected_status: ambiguous -> not_found; must_contain_missing: 정확히 같은 모델

### laptop-purchase-explain-1 · fail
...
- observed_summary: 검색 결과가 없습니다: 5070급 그래픽카드 보는 중인데 브라켓이나 완본체 같은 건 빼고 본품 위주로 뭐가 뜨는지
- notes: must_contain_missing: RTX; must_not_contain: 브라켓; must_not_contain: 완본체

### graphics-card-broad-search-2 · soft_fail
- prompt: RTX 5070 시리즈를 넓게 훑어보고 싶은데 조립PC 말고 카드 본체만 정리해줘
- expected_behavior: 5070 시리즈 broad search는 GPU 계열 중심으로 정리되어야 한다.
- observed_summary: 검색 결과가 없습니다: RTX 5070 시리즈를 넓게 훑어보고 싶은데 조립PC 말고 카드 본체만 정리해줘
- notes: must_not_contain: 조립PC

### graphics-card-broad-search-3 · fail
- prompt: 라데온 9070 쪽 보는 중이라 브라켓이나 완본체 섞지 말고 카드만 찾아줘
- expected_behavior: 라데온 broad search는 부속품과 완본체를 줄여야 한다.
- observed_summary: 검색 결과가 없습니다: 라데온 9070 쪽 보는 중이라 브라켓이나 완본체 섞지 말고 카드만
- notes: must_contain_missing: RX; must_not_contain: 브라켓; must_not_contain: 완본체

### graphics-card-broad-search-4 · soft_fail
- prompt: 5070 Ti 라인 보는데 지지대나 완본체 말고 본품만 검색 좀 해줘
- expected_behavior: 5070 Ti broad search는 그래픽카드 본품 중심이어야 한다.
- observed_summary: 검색 결과가 없습니다: 5070 Ti 라인 보는데 지지대나 완본체 말고 본품만 검색 좀 해줘
- notes: must_not_contain: 완본체
...
- observed_summary: 조탁 5070 Twin Edge 쪽이 궁금해서 ZOTAC RTX 5070 Twin Edge로 보이는 것만 기준 1개 모델, 10개 판매처를 찾았습니다.
- notes: (none)
...
- observed_summary: 검색 결과가 없습니다: ASUS TUF 5070 Ti 쪽으로 보는데 그 모델명 기준으로
- notes: (none)
...
- observed_summary: 검색 결과가 없습니다: Sapphire RX 9070 XT Pulse 이 라인만 보고 싶으니 다른 거 말고 그쪽만
- notes: (none)
...
- observed_summary: 검색 결과가 없습니다: PowerColor RX 9070 Hellhound 이 모델로 뜨는 것들만 한번 정리해줘
- notes: (none)
...
- observed_summary: 갤럭시 GALAZ 지포스 RTX 5070 EX GAMER BLACK OC D7 12GB 그래픽카드 단일 모델 기준 최저가 1228130원, 최고가 5106450원, 판매처 5곳입니다.
- notes: (none)
...
- observed_summary: 기가바이트 지포스 RTX 5070 Ti WINDFORCE OC SFF D7 16GB 피씨디렉트 기준 최저가 1478650원, 최고가 5183900원, 판매처 19곳입니다.
- notes: (none)

### graphics-card-exact-compare-3 · fail
- prompt: RX 9070 이건 XT 말고 일반형끼리만 비교해줘
- expected_behavior: RX 9070 exact compare는 XT와 섞이지 않고 ok여야 한다.
- observed_summary: 비교할 제품을 찾지 못했습니다. 검색어를 더 구체적으로 입력해 주세요.
- notes: expected_status: ok -> not_found; must_contain_missing: RX 9070
...
- observed_summary: PowerColor 라데온 RX 9070 XT HELLHOUND D6 16GB 대원씨티에스 기준 최저가 1080000원, 최고가 1432310원, 판매처 20곳입니다.
- notes: (none)

### graphics-card-broad-ambiguous-safety-1 · fail
...
- observed_summary: 파워컬러 헬하운드 스펙트럴 화이트 AMD 라데온 RX 9070 XT 16GB GDDR6 기준 최저가 719060원, 최고가 1432310원, 판매처 20곳입니다. 현재 최저가는 719060원이고 최고가와의 차이는 713250원입니다.
- notes: (none)

### graphics-card-purchase-explain-3 · fail
...
- observed_summary: 검색 결과가 없습니다: 게이밍 키보드 찾는 중인데 사무용 느낌 강한 거나 오피스용은 빼고 뭐가 뜨는지 볼래
...
- observed_summary: 검색 결과가 없습니다: 무선 기계식 키보드 보고 있는데 마우스나 사무용 키보드 같은 건 빼고 정리해줘
- notes: must_not_contain: 마우스; must_not_contain: 사무용

### keyboard-broad-search-3 · soft_fail
- prompt: 텐키리스 게이밍 키보드 쪽으로 보고 싶어서 풀배열 오피스용 말고 맞는 것만 보여줘
- expected_behavior: TKL 게이밍 키보드 검색은 게이밍/텐키리스 의도와 크게 어긋나지 않아야 한다.
- observed_summary: 검색 결과가 없습니다: 텐키리스 게이밍 키보드 쪽으로 보고 싶어서 풀배열 오피스용 말고 맞는 것만
- notes: must_not_contain: 오피스
...
- observed_summary: 검색 결과가 없습니다: 저소음 사무용 키보드 찾는 중인데 RGB 번쩍이는 게이밍 느낌은 빼고
...
- observed_summary: 검색 결과가 없습니다: 키크론 K2 Pro 생각 중이라 정확히 그 모델로 뜨는 것들만
...
- observed_summary: 검색 결과가 없습니다: 로지텍 mx mini라고들 하던데 정확히는 MX Mechanical Mini잖아, 그걸로
- notes: (none)
...
- observed_summary: 검색 결과가 없습니다: 앱코 K660 하나 보는데 키캡 같은 액세서리 말고 본체만
...
- observed_summary: 검색 결과가 없습니다: DrunkDeer A75 이 모델 궁금해서 정확히 맞는 것만 한번 찾아봐줘
- notes: (none)
...
- observed_summary: 비교할 제품을 찾지 못했습니다. 검색어를 더 구체적으로 입력해 주세요.
- notes: expected_status: ok -> not_found; must_contain_missing: Keychron; must_contain_missing: K2 Pro
...
- observed_summary: 비교할 제품을 찾지 못했습니다. 검색어를 더 구체적으로 입력해 주세요.
- notes: expected_status: ok -> not_found; must_contain_missing: MX Mechanical

### keyboard-exact-compare-3 · fail
- prompt: 앱코 K660 가격 차이만 깔끔하게 비교해줘
- expected_behavior: 앱코 K660 exact compare는 가능하면 ok 상태여야 한다.
- observed_summary: 비교할 제품을 찾지 못했습니다. 검색어를 더 구체적으로 입력해 주세요.
- notes: expected_status: ok -> not_found; must_contain_missing: 앱코; must_contain_missing: K660
...
- observed_summary: 검색 결과가 없습니다: 27인치 4K 모니터 찾는 중인데 TV나 이상한 액세서리 말고 본체 위주로 정리해줘
- notes: (none)
...
- observed_summary: 검색 결과가 없습니다: 32인치 QHD 모니터 보려는데 너무 엉뚱한 해상도는 빼고 대충 뭐가 있는지
- notes: (none)
...
- observed_summary: 울트라와이드 모니터 쪽으로 보는데 본체 말고 암이나 케이블 같은 건 빼고 기준 4개 모델, 4개 판매처를 찾았습니다.
- notes: (none)
...
- observed_summary: 검색 결과가 없습니다: 고주사율 게이밍 모니터 보는 중인데 TV나 다른 기기 말고 모니터만
...
- observed_summary: 검색 결과가 없습니다: LG 27GR93U 이 모델로 검색 좀 해줘, 비슷한 다른 모델 말고
- notes: (none)
...
- observed_summary: 검색 결과가 없습니다: DELL U2723QE 하나 보는 중인데 정확한 모델명으로 뜨는 것만
- notes: (none)
...
- observed_summary: 비교할 제품을 찾지 못했습니다. 검색어를 더 구체적으로 입력해 주세요.
- notes: expected_status: ok -> not_found; must_contain_missing: U2723QE
...
- observed_summary: 비교할 제품을 찾지 못했습니다. 검색어를 더 구체적으로 입력해 주세요.
- notes: expected_status: ok -> not_found; must_contain_missing: 321URX
...
- observed_summary: 비교할 제품을 찾지 못했습니다. 검색어를 더 구체적으로 입력해 주세요.
- notes: expected_status: ok -> not_found; must_contain_missing: S27DG500

### monitor-broad-ambiguous-safety-1 · fail
...
### monitor-purchase-explain-2 · fail
...
- notes: expected_status: ok -> ambiguous; must_contain_missing: 27GR93U
...
- observed_summary: 캡슐 프라레일 토마스와 나카마들 치열한 기관차 정확히 철도편 전 18종(대전차 대색 차이 Ver.들이) 1개 기준 최저가 172320원, 최고가 172320원, 판매처 1곳입니다.
- notes: must_contain_missing: 9800X3D; must_contain_missing: Ryzen

### pc-part-exact-compare-3 · pass
- prompt: SN850X 2TB는 용량까지 맞는 것끼리만 비교해줘
- expected_behavior: SSD exact compare는 ok 상태를 목표로 한다.
- observed_summary: WD SN850X NVMe 2TB 기준 최저가 313500원, 최고가 3301020원, 판매처 16곳입니다.
- notes: (none)

### pc-part-exact-compare-4 · pass
- prompt: SF-850F14XG는 같은 파워 모델끼리만 가격 비교해줘
- expected_behavior: 파워 exact compare는 ok 상태를 목표로 한다.
- observed_summary: 슈퍼플라워 SF-850F14XG LEADEX VII GOLD BLACK ATX 3.0 (PCIE5) 기준 최저가 178990원, 최고가 299200원, 판매처 20곳입니다.
- notes: (none)

### pc-part-broad-ambiguous-safety-1 · fail
- prompt: B650 메인보드 전체 가격 비교는 넓을 테니 안 되면 멈추고 추천 검색어를 줘
- expected_behavior: B650 broad compare는 ambiguous로 멈추고 모델 재질문을 유도해야 한다.
- observed_summary: 비교할 제품을 찾지 못했습니다. 검색어를 더 구체적으로 입력해 주세요.
- notes: expected_status: ambiguous -> not_found; must_contain_missing: 정확히 같은 모델; missing_suggested_queries

### pc-part-broad-ambiguous-safety-2 · fail
...
- observed_summary: 비교할 제품을 찾지 못했습니다. 검색어를 더 구체적으로 입력해 주세요.
- notes: expected_status: ok -> not_found; must_contain_missing: 9800X3D; must_contain_missing: Ryzen

### pc-part-purchase-explain-3 · fail
- prompt: 9800X3D는 요즘 사도 괜찮은 가격인지 봐줘
- expected_behavior: SSD exact explain은 ok 상태를 목표로 한다.
- observed_summary: 비교할 제품을 찾지 못했습니다. 검색어를 더 구체적으로 입력해 주세요.
- notes: expected_status: ok -> not_found; must_contain_missing: SN850X; must_contain_missing: 2TB
...
- observed_summary: WD SN850X NVMe 2TB 기준 최저가 313500원, 최고가 3301020원, 판매처 16곳입니다. 현재 최저가는 313500원이고 최고가와의 차이는 2987520원입니다.
